...
declare -A TOOLS_TO_CHECK=(
    ...
    ["ZPhisher"]="[ -d ~/zphisher ] && echo true;git clone https://github.com/htr-tech/zphisher ~/zphisher;Automated phishing framework"
    ["SET"]="[ -d ~/set ] && echo true;git clone https://github.com/trustedsec/social-engineer-toolkit ~/set;The Social-Engineer Toolkit"
    ...
    ["ATSCAN"]="[ -d ~/ATSCAN ] && echo true;git clone https://github.com/AlisamTechnology/ATSCAN.git ~/ATSCAN;Dork search & exploit scanner"
    ["bing-ip2hosts"]="[ -d ~/bing-ip2hosts ] && echo true;git clone https://github.com/bing-ip2hosts/bing-ip2hosts.git ~/bing-ip2hosts;Discover sites by IP"
    ["CloudEnum"]="pip show cloudenum > /dev/null 2>&1;pip install cloudenum;Multi-cloud resource enumeration"
    ["CMSeeK"]="[ -d ~/CMSeeK ] && echo true;git clone https://github.com/T-Rex-2000/CMSeeK.git ~/CMSeeK;CMS detection & exploitation"
    ["CMSmap"]="[ -d ~/CMSmap ] && echo true;git clone https://github.com/CMSmap/CMSmap.git ~/CMSmap;Automated CMS flaw detection"
    ["Crips"]="[ -d ~/Crips ] && echo true;git clone https://github.com/Manisso/Crips.git ~/Crips;IP/DNS info tool"
    ...
    ["Fimap"]="[ -d ~/fimap ] && echo true;git clone https://github.com/fimap/fimap.git ~/fimap;LFI/RFI scanner"
    ["Commix"]="[ -d ~/commix ] && echo true;git clone https://github.com/commixproject/commix.git ~/commix;Command injection exploiter"
    ...
    ["Patator"]="[ -d ~/Patator ] && echo true;git clone https://github.com/Patator/Patator.git ~/Patator;Multi-purpose brute-forcer"
    ...
    ["SocialFish"]="[ -d ~/SocialFish ] && echo true;git clone https://github.com/UndeadSec/SocialFish.git ~/SocialFish;Phishing toolkit"
    ...
    ["HiddenEye"]="[ -d ~/HiddenEye ] && echo true;git clone https://github.com/DarkSecDevelopers/HiddenEye.git ~/HiddenEye;Phishing framework"
    ["BlackEye"]="[ -d ~/BlackEye ] && echo true;git clone https://github.com/An0nUD4Y/blackeye.git ~/BlackEye;Phishing pages generator"
    ["ShellPhish"]="[ -d ~/ShellPhish ] && echo true;git clone https://github.com/thelinuxchoice/shellphish.git ~/ShellPhish;Phishing toolkit"
    ["Weeman"]="[ -d ~/weeman ] && echo true;git clone https://github.com/samyk/weeman.git ~/weeman;HTTP phishing server"
